...
from PyQt4.QtGui import QAbstractTextDocumentLayout, QStyledItemDelegate, QStyle, QApplication, \
                        QTextDocument, QAbstractTextDocumentLayout, QStyleOptionViewItemV4
